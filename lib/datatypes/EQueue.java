...
public class EQueue <E> implements Collection<E>, Iterable<E>, Comparable<EQueue<E>>, List<E>
{
	public EQueue()
	{
		size = 0;
	...
	{
		return new EQueueListIterator(head, this);
	}
	...
	{
		checkBounds(arg0);
		return new EQueueListIterator(head, arg0, this);
	}
	...
	@Override
	public int compareTo(EQueue<E> o) 
	{
		return size - o.size;
	}
	...
	{
		return new EQueueIterator(head);
	}
	...
	private final class EQueueListIterator implements ListIterator<E>
	{
		public EQueueListIterator(Node n, EQueue<E> parent)
		{
			this.parent = parent;
			head = n;
			index = 0;
		...
		public EQueueListIterator(Node n, int start, EQueue<E> parent)
		{
			this.parent = parent;
			head = n;
			index = start;
		...
		private final EQueue<E> parent;
	}
	
	private final class EQueueIterator implements Iterator<E>
	{
		public EQueueIterator(Node head)
		{
			current = head;
		}
